...
if(REXSDK_DIR)
    ...
    if(REXSDK_VERSION)
        ...
        find_package(rexglue 0.7.1 QUIET CONFIG)
    endif()
...
# Codegen target - run 'cmake --build . --target joyrideturbo_codegen'
add_custom_target(joyrideturbo_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/joyrideturbo_config.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for joyrideturbo"
    VERBATIM
)
