# Joy Ride Turbo Recompiled

**JoyRideRecomp** is a recompilation Project with hopes to port the game Joy Ride Turbo and Kinect Joy Ride to Windows and Linux. It uses a [ReXGlue SDK](https://github.com/rexglue/rexglue-sdk)
